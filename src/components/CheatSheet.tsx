...
const CheatSheet = () => {
  ...
  const cheatSheetItems = [
    ...
    { title: 'Data Types', content: 'String, Number, Boolean, Null, Undefined, Symbol, BigInt' },
    { title: 'Operators', content: 'Arithmetic, Assignment, Comparison, Logical, Bitwise' },
    { title: 'Functions', content: 'Function declarations, expressions, arrow functions' },
    { title: 'Arrays', content: 'Creating arrays, accessing elements, methods' },
  ...
  return (
    <section id="cheatsheet" className="cheatsheet container">
      <input type="text" className="search-bar" placeholder="Search the cheat sheet..." />
